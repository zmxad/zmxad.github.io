...
live2d_settings['homePageUrl']          = 'https://cnm23333.xyz/';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://cnm23333.xyz/';   // 关于页地址, '{URL 网址}'
live2d_settings['screenshotCaptureName']= '二次元.png'; // 看板娘截图文件名，例如 'live2d.png'
